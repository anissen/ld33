...
class Main extends luxe.Game {
    ...
    override function config(config:luxe.AppConfig) {
        ...
        config.preload.textures.push({ id:'assets/monster_closed_mouth.png' });
        config.preload.textures.push({ id:'assets/monster_closed_eyes.png' });
        ...
        config.preload.texts.push({ id:'assets/level5.tmx' });
        config.preload.texts.push({ id:'assets/level6.tmx' });
        config.preload.texts.push({ id:'assets/level7.tmx' });
        ...
        for (sound in sounds) {
            config.preload.sounds.push({ 
                id: 'assets/sounds/hit/$sound.ogg', 
                name: sound, 
                is_stream: false
            });
        }
